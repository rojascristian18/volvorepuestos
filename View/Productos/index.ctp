			...
			<div class="col-sm-3">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<div class="acciones">
							<button class='btn btn-primary btn-agregar-carro'  data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-content="And here's some amazing content. It's very engaging. Right?" data-producto='<?=$producto['Producto']['id'];?>'>Agregar a cotización</button>
						</div>
					</div>
				</div>
			</div>
